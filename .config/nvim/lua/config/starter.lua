-- based off 'echasnovski/mini.nvim' mini.starter 
local Starter = {}
local H = {}
...
Starter.setup = function()
	H.create_autocommands()
end

Starter.open = function(buf_id)
...
Starter.refresh = function(buf_id)
...
H.create_autocommands = function()
	local augroup = vim.api.nvim_create_augroup("Starter", {})
...
H.make_buffer_autocmd = function(buf_id)
	local augroup = vim.api.nvim_create_augroup("StarterBuffer", {})
...
H.create_lines = function(text)
	...
	for _, line in ipairs(text_lines) do
		local hor_padding = math.floor((win_width - 35) / 2)
		table.insert(lines, string.rep(" ", 10) .. line)
	end
